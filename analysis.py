...
try:
    mean_informed_swarm_results = pd.read_csv("results/simulation_20230304_144339/results.csv")
except FileNotFoundError:
    print("Results not found.")
    exit(1)
...
try:
    ...
    median_informed_swarm_results = pd.read_csv("results/simulation_20230304_145155/results.csv")
except FileNotFoundError:
    print("Results not found.")
    exit(1)
